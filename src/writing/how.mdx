...
Your personal token represents your equities in companies and other personal tokens.

Personal tokens exist within a network (the "Network"). Every user, whether they want to raise capital, or invest in other personal tokens, will need to create their personal token.
...
In this way, the Network token represents all of the personal tokens in the Network.

(TODO: add Network token visualization)
...
<Accordion title="Can a personal token IPO?">
