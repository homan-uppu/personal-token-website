...
*TODO: add the personal token visual here*.
...
You can invest in personal tokens *through* your personal token.
...
- Would there be some notion of a "personal token IPO" similar to companies such that anyone can freely buy and sell shares without going through a tightly controlled fundraising process? What could be the benefits of this? Why wouldn't it make sense?
- 