...
The current market may be efficient (which I strongly doubt), but there also exists a very large talent market earlier in the lifecycle of individuals that doesn't yet exist, but would be very valuable if it did exist - for both the individuals raising capital and the investors
